...
String logfilename = getInitParameter("logfile"); /* logfilename - получает им€ файла конфигурации из пар-ра инициализации сервлета*/ 
String pref ="";
pref = getServletContext().getRealPath("/");

/*pref Ц указывает на путь к файлу конфигурации*/
//s.configure(pref+logfilename);
